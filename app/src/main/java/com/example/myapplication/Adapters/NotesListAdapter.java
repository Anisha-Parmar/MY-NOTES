...
public class NotesListAdapter extends RecyclerView.Adapter<NotesViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NotesViewHolder notesViewHolder, int position) {
        notesViewHolder.textView_title.setText(list.get(position).getTitle());
        notesViewHolder.textView_title.setSelected(true);

        notesViewHolder.textView_notes.setText(list.get(position).getNotes());
        notesViewHolder.textView_date.setText(list.get(position).getDate());
        notesViewHolder.textView_date.setSelected(true);

        if(list.get(position).isPinned()){
            notesViewHolder.ImageView_pin.setImageResource(R.drawable.pin_image);
        }
        else{
